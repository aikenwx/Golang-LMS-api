...
func TestCase1(t *testing.T) {
	...
	testPost(`{}`, "/api/register", 400, `{"message":"Required fields for the request are missing or have invalid types"}`, t)
	...
	testPost(`{"teacher": [], "students":"test1@gmail.com"}`, "/api/register", 400, `{"message":"Required fields for the request are missing or have invalid types"}`, t)
	testDelete(t)
	testGet("/api/commonstudents", 400, `{"message":"Required fields for the request are missing or have invalid types"}`, t)
	testPost(`{"teacher": "test@gmail.com", "students":["test1@gmail.com","test2@gmail.com"]}`, "/api/register", 204, "", t)
	testPost(`{}`, "/api/register", 400, `{"message":"Required fields for the request are missing or have invalid types"}`, t)
	testGet("/api/commonstudents?teacher=test%40gmail.com", 200, `{"students":["test1@gmail.com","test2@gmail.com"]}`, t)
	testGet("/api/commonstudents?teacher=nani%40gmail.com", 200, `{"students":[]}`, t)
